...
for (let pokemon of pokemonz) {
  pokemon.addEventListener("click", function () {
    ...
    if (
      ...
      pokemon.innerHTML == '<i class="nes-pokeball"></i>'
    ) {
      pokemon.innerHTML = "";
      pokemon.innerHTML =
        '<a href= "https://pokemon.fandom.com/wiki/Bulbasaur"><i class="nes-bulbasaur"></i></a>';
      ...
      pokemon.innerHTML = "";
      pokemon.innerHTML =
        '<a href= "https://pokemon.fandom.com/wiki/Charmander"><i class="nes-charmander"></i></a>';
      ...
      pokemon.innerHTML = "";
      pokemon.innerHTML =
        '<a href= "https://pokemon.fandom.com/wiki/Squirtle"><i class="nes-squirtle"></i></a>';
      char.innerHTML = '<i class="nes-pokeball"></i>';
      bulb.innerHTML = '<i class="nes-pokeball"></i>';
    }
  });
